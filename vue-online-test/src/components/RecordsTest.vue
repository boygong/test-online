<template>
  <div>
    <el-table :data="tableData" style="width: 100% ;position: relative;left:5% "
      :default-sort="{ prop: 'time', order: 'descending' }">
      <el-table-column type="index" label="序号" width="180">
      </el-table-column>
      <el-table-column prop="time" label="日期" sortable :formatter="formatDate" width="200">
      </el-table-column>
      <el-table-column prop="name" label="考试科目" width="200">
      </el-table-column>
      <el-table-column prop="core" label="成绩" sortable>
      </el-table-column>
    ...
    <div class="block" style="position: relative; left: 180px;top: 30px;">
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage"
        :page-sizes="[5, 6, 7, 8]" :page-size="this.pageSize" layout="total, sizes, prev, pager, next, jumper"
        :total="this.total">
      </el-pagination>
    </div>
  </div>
...
export default {
  ...
  methods: {
    handleCurrentChange(val) {
      ...
      const student_id = parseInt(user.studentId);
      ...
      axios.get('http://localhost:4399/records', {
        ...
        .then(response => {
          this.tableData = response.data.source;
