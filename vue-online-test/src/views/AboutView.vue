      ...
      <el-dialog title="个人信息" :visible.sync="dialogFormVisible" width="30%">
          ...
          <el-form :model="form" style="flex: 1;">
            ...
            <el-form-item label="学生Id" :label-width="formLabelWidth">
              <el-input v-model="form.studentId" autocomplete="off" :disabled="true" style="width: 100px;"></el-input>
            </el-form-item>
            <el-form-item label="班级" :label-width="formLabelWidth">
              <el-input v-model="form.className" autocomplete="off" :disabled="true" style="width: 100px;"></el-input>
            </el-form-item>
          </el-form>
          <div style="flex: 1;">
            <el-form :model="form">
